...
export const IpcChannels = {
  ...
  cliSetupGetStatuses: 'cliSetup:getStatuses',
  cliSetupGetPlan: 'cliSetup:getPlan',
  cliSetupInstall: 'cliSetup:install',
  cliSetupCancelInstall: 'cliSetup:cancelInstall',
  cliSetupInstallProgress: 'cliSetup:installProgress',
  cliSetupSignIn: 'cliSetup:signIn',
  cliSetupPtyWrite: 'cliSetup:ptyWrite',
  cliSetupPtyResize: 'cliSetup:ptyResize',
  cliSetupPtyInterrupt: 'cliSetup:ptyInterrupt',
  cliSetupPtyKill: 'cliSetup:ptyKill',
  cliSetupPtyData: 'cliSetup:ptyData',
  cliSetupPtyExit: 'cliSetup:ptyExit',
  cliSetupOpenTerminal: 'cliSetup:openTerminal',
  cliSetupOpenInstallLogs: 'cliSetup:openInstallLogs',
